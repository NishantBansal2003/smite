...
pub use funding_signed::FundingSignedGenerator;
...
pub enum AnyGenerator {
    ...
    FundingSigned(FundingSignedGenerator),
}
...
impl AnyGenerator {
    ...
    pub const ALL: &[Self] = &[
        ...
        Self::FundingSigned(FundingSignedGenerator),
    ];
}
...
impl Generator for AnyGenerator {
    fn generate(&self, builder: &mut ProgramBuilder, rng: &mut impl Rng) {
        match self {
            ...
            Self::FundingSigned(generator) => generator.generate(builder, rng),
        }
    }
}
